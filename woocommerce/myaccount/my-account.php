...
<div class="myaccount-header">
	<div class="myaccount-header__top">
		...
		<a href="<?php echo esc_url( wc_logout_url() ); ?>" class="myaccount-header__logout wp-element-button myaccount-tabs__link wp-block-button__link has-base-color has-secondary-background-color has-text-color has-background has-link-color has-text-align-center wp-element-button">
